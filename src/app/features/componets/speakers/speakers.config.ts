...
Regulación de Servicios Públicos por la Universidad del Pacífico, con un máster en Gestión de
Infraestructura de Obra por la Universidad Politécnica de Catalunya y una especialización en
arbitraje internacional por la Universidad San Pablo de España. Actualmente, es Jefa Legal de
Operaciones en Constructora MPM S.A Perú y es miembro de las nóminas arbitrales de
destacadas instituciones en Perú. Es fundadora y presidenta de la Asociación de Mujeres Líderes
en Construcción JRD/DAB, una iniciativa que promueve la visualización de mujeres en los
...
Eepresenta con orgullo a México como delegada en el Comité Asesor del T-MEC sobre Disputas Comerciales Privadas (Comité 3122 ADR), demostrando su compromiso con los asuntos legales internacionales y la resolución de disputas.
Además, Christa es miembro de diversas instituciones, incluyendo:
Miembro de la Comisión de Arbitraje y ADR de la ICC
Miembro del Grupo Latinoamericano de Arbitraje de la ICC
Presidenta del Comité de México de la ICC para la Solución de Controversias en Infraestructura
Miembro del Comité Ejecutivo del Capítulo Mexicano del Club Español e Iberoamericano de Arbitraje (CEIA)
Miembro del Consejo Directivo de la Asociación Latinoamericana de Derecho de la Construcción (ALDEC).
Es profesora en el posgrado de Arbitraje Comercial Internacional impartido por la Escuela Libre de Derecho e ICC México. `,
    },
    {
